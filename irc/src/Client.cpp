...
void Client::sendWelcomeMessage() {
    std::string welcome = ":server 001 " + getNickname() + " :Welcome to the IRC server " + getNickname() + "!" + getUsername() + "@localhost";
    sendMessage(welcome);
    
    // Mensajes de bienvenida estándar
    sendMessage(":server 002 " + getNickname() + " :Your host is irc.server.net");
    sendMessage(":server 003 " + getNickname() + " :This server was created now");
    sendMessage(":server 004 " + getNickname() + " :irc.server.net 1.0 iwszok");
}
